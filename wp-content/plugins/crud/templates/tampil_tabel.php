...
<body>
    ...
    <div class="container bg-light py-3">
        ...
        <div class="row" style=" overflow-x:auto">
            <div class="col-md-7 ml-auto mr-1">
            ...
            <div class="col-md-5 pt-2">
                <button class="btn btn-md btn-primary mr-4 mt-2"  data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@getbootstrap"><b><span class="dashicons dashicons-insert mt-1  mb-1"></span> Tambah Saldo</b></button>
                <button class="btn btn-md btn-info mt-2"  data-bs-toggle="modal" data-bs-target="#exampleModalDua" data-bs-whatever="@getbootstrap"><b><span class="dashicons dashicons-remove mt-1 mb-1"></span> Kurangi Saldo</b></button>
